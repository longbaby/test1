...
<script type="text/javascript" src="${ctx}/scripts/ebankLogin.js"></script>
</head>
<body onload="styleSetEbank()">
<!-- 包含头部 -->
...
<div id="entry_n" class="rel content clm shopuser">
  <div class="form" id="login_list">
    <ul class="tab_user_t cfx">    
      <!--  <a href="javascript:;"><li>&nbsp;<i></i></li></a>
      <a href="javascript:;"><li class="two active">&nbsp;<i></i></li></a>
       -->
    ...
    <form:form method="post" commandName="${commandName}" htmlEscape="true"   id="form1" name="form1" >
		    <div class="tab_con"  style="display:block;"> 
			        ...
			        -->
 					<div id="pa1" class="txt3 txt_pad" style="cursor:text">
			        	...
			        	type="paypass"   
						 objectWidth="375"
						objectHeight="30" 
						minLength="4" maxLength="30" rule="10111"
		      ...
		      <!--end 个人登录--> 
		      		<ul>
													<!-- 合并页面登录场景 -->		      		
		      									<input type="hidden" name="loginWay" value="8" />
