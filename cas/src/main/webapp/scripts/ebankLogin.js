...
function setTextDefVal(_this,isFcs,defValue,def_c){
	  var color=def_c?def_c:'col_grey';
...
function styleSetEbank(){
	$("#username").css("color","#333");
	if($("#username").val() == "" || $("#username").val()=='网银账号/用户名/手机号' ||$("#username").val()== null ){
		$("#username").css("color","#999");
		$("#username").val('网银账号/用户名/手机号');
	}
	
	$("#username").focus(function(){
		var search = $("#username").val();
		if(search == '网银账号/用户名/手机号'){
			$("#username").css("color","#333");
			$("#username").val("");
		}
	}).blur(function(){
		var search2 = $("#username").val();
		if(search2 == ''){
			$("#username").css("color","#999");
			$("#username").val('网银账号/用户名/手机号');
		}
...
function styleSet(){
	$("#username").css("color","#333");
	if($("#username").val() == "" || $("#username").val()=='网银账号/网银别名/网银手机号/商城用户名/商城手机号登录' ||$("#username").val()== null ){
		$("#username").css("color","#999");
		$("#username").val('网银账号/网银别名/网银手机号/商城用户名/商城手机号登录');
	}
	
	$("#username").focus(function(){
		var search = $("#username").val();
		if(search == '网银账号/网银别名/网银手机号/商城用户名/商城手机号登录'){
			$("#username").css("color","#333");
			$("#username").val("");
		}
	}).blur(function(){
