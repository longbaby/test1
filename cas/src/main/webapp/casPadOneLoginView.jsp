   	...
   	$("#id_btn_mall").click(function(){
   		...
   		if(jQuery.trim(username) == ""
			|| username == $("#id_username").attr("default")){
	   		...
	   		//alert(usernameLen);
	   		if(usernameLen < 1 || usernameLen > 20){
		...
		if(password == null || password == ""){
			...
			return;
	   		...
	   		if(!keyBoardFlag){
	   			...
	   			var diReg = /^[0-9]*$/;
	   			var chReg = /^[A-Za-z]*$/;
	   			if(passwordLen <4 || passwordLen > 30 ){
	   				$("#id_errInfo_before").html("密码长度为4到30个字符！");
	   				return;	
	   			}
	   			...
	   			if(passwordLen < 4){
	   	   			$("#id_errInfo_before").html("密码长度至少应该为四位!");
	   	   			return ;
	   	   		}
	   		}
			    	...
			    	<form:form method="post" commandName="${commandName}" htmlEscape="true" id="id_form_mall" name="form_mall">
					    <div class="tab_con"  style="display:block;"> 
							...
							<ul class="tab_con_g">
								...
								<li>
								  	<input type="text" data-role="none" class="txt" name="username" id="id_username" value="" maxLength="20"  placeholder="网银账号/网银别名/网银手机号/商城用户名/商城手机号登录" onkeydown="enterKeySubmit(event);"/>
								</li>		     
								<li>
