 ...
 */
public final class SSafeContextLoaderListener implements ServletContextListener {
    ...
    private final SpringContextLoaderListener delegate = new SpringContextLoaderListener();
